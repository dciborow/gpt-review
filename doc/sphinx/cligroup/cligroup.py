...
cli_field_types = [
    Field("summary", label="Summary", has_arg=False, names=("summary", "shortdesc")),
    Field("description", label="Description", has_arg=False, names=("description", "desc", "longdesc")),
]
...
class CliGroupDirective(CliBaseDirective):
    ...
    doc_field_types.extend(
        [
            Field("docsource", label="Doc Source", has_arg=False, names=("docsource", "documentsource")),
...
class CliArgumentDirective(CliBaseDirective):
    ...
    doc_field_types.extend(
        [
            ...
            Field("values", label="Allowed values", has_arg=False, names=("values", "choices", "options")),
            Field("default", label="Default value", has_arg=False, names=("default")),
            Field("source", label="Values from", has_arg=False, names=("source", "sources")),
            Field("deprecated", label="Deprecated", has_arg=False, names=("deprecated")),
        ]
    )
